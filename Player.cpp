/*
 * Player.cpp - Implementation cho Player class trong game Scrabble
 * 
 * Tác giả: Đàm Hồng Quân
 * Mã sinh viên: 24022712
 * Mô tả: Thực hiện các method của Player class bao gồm quản lý
 *        thông tin người chơi, bộ quân cờ và điểm số
 */
